...
export const SHORTCUT_GROUPS: ShortcutGroup[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { keys: '/', action: 'Open block command menu (type /heading, /quote, /curl, /calendar, /table, etc.)' },
      ...
      { keys: 'Tab / Shift + Tab', action: 'Next / previous table cell (Tab at last cell adds a row)' },
      { keys: 'Ctrl + Shift + ↑ / ↓', action: 'Add table row above / below' },
      { keys: 'Ctrl + Shift + ← / →', action: 'Add table column before / after' },
      { keys: 'Ctrl + Shift + Backspace', action: 'Delete table row' },
      { keys: 'Ctrl + Alt + Backspace', action: 'Delete table column' },
    ],
  },
]
